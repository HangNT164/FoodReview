...
<%--                        --%>
<%--                        <div class="modal fade" id="update${yc.shopCommentId}" tabindex="-1"--%>
<%--                             role="dialog" aria-labelledby="update${yc.shopCommentId}"--%>
<%--                             aria-hidden="true">--%>
...
<%--                                    <div class="card">--%>
<%--                                        <div class="card-body">--%>
<%--                                            <form action="update-your-comment?shopCommentId=${yc.shopCommentId}"--%>
<%--                                                  method="post">--%>
