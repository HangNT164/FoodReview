            ...
            <div class="col-10">
                <div class="left-text-content">
                    <c:forEach items="${topicCommentList}" var="t">
                        ...
                        <!-- add comment modal -->
                        <div class="modal fade" id="create${t.topicCommentId}" tabindex="-1"
                        role="dialog" aria-labelledby="create${t.topicCommentId}"
                        aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-lg"
                                 role="document">
                                <div class="modal-content">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="mb-3">Edit comment </h5>
                                            <form action="topic-comment?commentId=${t.topicCommentId}&topicId=${topic.topicId}&action=create"
